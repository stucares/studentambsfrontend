...
const AdminPremiumSettings = () => {
  ...
  const fetchSettings = async () => {
    try {
      ...
      toast.error(error.userMessage || 'Unable to load settings. Please refresh the page.');
      setLoading(false);
    }
  };
  ...
  const handleSaveReferralSettings = async () => {
    ...
    try {
      ...
      toast.error(error.userMessage || 'Unable to save referral settings. Please try again.');
    } finally {
      setSaving(false);
    }
  };
  ...
  const handleSavePopupSettings = async () => {
    ...
    try {
      ...
      toast.error(error.userMessage || 'Unable to save popup settings. Please try again.');
    } finally {
      setSaving(false);
    }
  };
