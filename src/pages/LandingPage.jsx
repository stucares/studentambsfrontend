      ...
      <section className="pt-24 sm:pt-32 pb-12 sm:pb-20 px-4 bg-gradient-to-br from-primary-50 via-white to-lime-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 bg-primary-100 text-primary-700 px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-medium mb-4 sm:mb-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
                <Link
                  to="/register"
                  className="btn-primary px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg flex items-center justify-center gap-2"
                >
                  Get Premium @ ₹19
                ...
                <a
                  href="#how-it-works"
                  className="px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg font-semibold text-gray-700 border-2 border-gray-200 rounded-xl hover:border-primary-300 transition-all flex items-center justify-center gap-2"
                >
                  Learn More
                </a>
              </div>
            ...
            >
              ...
              <div className="glass-card p-6 sm:p-8 relative overflow-hidden">
                ...
                <div className="flex items-center gap-2 mb-4 mt-8 sm:mt-0">
                  <BadgeCheck className="w-6 h-6 sm:w-8 sm:h-8 text-primary-500" />
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            >
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 leading-relaxed font-medium text-primary-700">
            ...
            >
              <div className="flex items-center gap-3 sm:gap-4 mb-4 sm:mb-6">
                <div className="w-10 h-10 sm:w-14 sm:h-14 bg-gradient-to-br from-lime-400 to-lime-600 rounded-2xl flex items-center justify-center">
                  <BookOpen className="w-6 h-6 sm:w-8 sm:h-8 text-white" />
                </div>
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold text-gray-900">StuQuiz</h3>
                  <p className="text-sm sm:text-base text-gray-500">Learn Through Play</p>
                </div>
              </div>
              <p className="text-sm sm:text-base text-gray-600 mb-3 sm:mb-4 leading-relaxed">
              ...
              <p className="text-sm sm:text-base text-gray-600 mb-4 sm:mb-6 leading-relaxed font-medium text-lime-700">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            {howItWorks.map((item, index) => (
              ...
              >
                <div className="w-14 h-14 sm:w-16 sm:h-16 bg-gradient-to-br from-primary-500 to-primary-600 rounded-2xl flex items-center justify-center text-white text-xl sm:text-2xl font-bold mx-auto mb-3 sm:mb-4 shadow-lg shadow-primary-500/30">
                  {item.step}
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-gray-900 mb-2">{item.title}</h3>
                <p className="text-sm sm:text-base text-gray-600">{item.description}</p>
                {index < 3 && (
                  <div className="hidden lg:block absolute top-6 sm:top-8 left-[60%] w-[80%] border-t-2 border-dashed border-gray-300"></div>
                )}
              </motion.div>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
            {premiumBenefits.map((benefit, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="glass-card p-5 sm:p-6 hover:shadow-xl transition-all duration-300 group"
              >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
            {[
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="bg-white/10 backdrop-blur-lg rounded-2xl p-5 sm:p-6 border border-white/20"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="relative text-center">
              <div className="inline-flex items-center gap-2 bg-red-100 text-red-600 px-3 sm:px-4 py-2 rounded-full text-xs sm:text-sm font-bold mb-4 sm:mb-6 animate-pulse">
